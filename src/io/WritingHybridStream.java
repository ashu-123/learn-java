...
import io.model.Fable;
import io.util.AesopReader;
import io.util.FableData;
...
public class WritingHybridStream {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Fable> fables = aesopReader.readFable("src/resources/aesop.txt");
...
//		<binary texts>
		...
		File file = new File("src/resources/aesops-compressed.bin");
